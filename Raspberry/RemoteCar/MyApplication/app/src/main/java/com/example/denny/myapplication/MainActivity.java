...
public class MainActivity extends AppCompatActivity {
    ...
    private void createWidget() {
        ...
        bt_backward.setOnTouchListener(new RepeatListener(100, 100, new OnClickListener() {
            @Override
            public void onClick(View v) {
                new sendMessage("backward").start();
            }
        }));
        bt_left = (Button) findViewById(R.id.left);
        bt_left.setOnTouchListener(new RepeatListener(100, 100, new OnClickListener() {
            @Override
            public void onClick(View v) {
                new sendMessage("left").start();
            }
        }));
        bt_right = (Button) findViewById(R.id.right);
        bt_right.setOnTouchListener(new RepeatListener(100, 100, new OnClickListener() {
            @Override
            public void onClick(View v) {
                new sendMessage("right").start();
            }
        }));
    }
